      ...
      <div className={container} id="aboutMe">
        ...
        <div className={`animate ${contentContainer}`}>
          ...
          <p>
            ...
            modules, developing innovative in-house tools, and optimizing SEO
            and page load speeds. My accomplishments in hackathons and
            competitions further highlight my ability to thrive in high-energy
            settings.
          </p>
          <p>
